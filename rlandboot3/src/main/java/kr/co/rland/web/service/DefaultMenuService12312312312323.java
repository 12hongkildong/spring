...
//@Service
public class DefaultMenuService12312312312323 implements MenuService {
...
//		return repository.findAll(0,10,"",null,null,"regDate","desc");
	...
	public List<Menu> getList(int page) {
		...
		int size = 10;
		List<Menu> list = repository.findAll(0, size, null, null, null, null, null);
	...
	public List<Menu> getList(int page, String query) {
		...
		int size = 10;
		List<Menu> list = repository.findAll(0, size, query, null, null, null, null);
		return list;
	}
